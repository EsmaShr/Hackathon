...
// const initialTime = document.querySelector('#initTime');
...
//   response.open('GET', 'https://type.fit/api/quotes', true);
//   response.send();
...
/// pomodoro method
// putting a timer with different options
// when the timer goes on
// put another timer for the break
// put a nice relaxing sound or video with 'it's time to take a break'
// give suggestions of multiples meditations / exercises / stretches / play games (try to get the game on the page)
// when break timer is done
// put the previous page back
// put/generate a random motivation quote // use API here
